...
export default function Navigation() {
  ...
  const handleLogoutClick = () => {
    ...
    // Example: Clear local storage, redirect to login page, etc.
            ...
            <div className="flex h-16 items-center">
              ...
              <Popover.Group className="hidden lg:ml-8 lg:block lg:self-stretch z-10">
                <div className="flex h-full space-x-8">
                  {navigation?.categories.map((category) => (
                    <Popover key={category.name} className="flex" open={open} onClose={handleClose}>
                      {({ open , close }) => (
                        <>
                                          ...
                                          >
                                            {section?.items.map((item) => (
                                              <li key={item.name} className="flex">
                                                <a onClick={()=>handleCategoryClick(category,section,item,close)} href={item.href} className="hover:text-gray-800">
                                                  {item.name}
                                                </a>
                                              </li>
                                            ))}
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {auth.user?.firstName?(
                    ...
                    <Button
                      onClick={handleOpen} 
                      classNames="text-sm font-medium text-gray-700 hover:text-gray-800"
                    >
                      Signin
                    </Button>
                  )}
