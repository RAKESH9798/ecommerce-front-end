...
export default function Product() {
  ...
  const handleFilter = (value, sectionId) => {
    ...
    const query = searchParamms.toString();
    navigate({ search: `?${query}` }); // Note the use of backticks (`) instead of single quotes ('')
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div className="lg:col-span-4 w-full">
                <div className='grid grid-cols-2 lg:grid-cols-4 gap-4 justify-center bg-white py-5'>
                  
                  {mens_kurta.products?.content?.map((item) => (
          ...
          <section className='w-full px=[3.6rem'>
            <div className='px-4 py-y flex justify-center'>
