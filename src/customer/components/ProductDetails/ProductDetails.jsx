    ...
    return (
        <div className="bg-white lg-px-20">
            <div className="pt-6">
                    ...
                    <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <p className="text-green-600 font-semibold"><span>{products.product?.discountPercent}</span></p>
                            </div>
                            ...
                            <p className='opacity-50 text-sm'>4566 Ratings</p>
                            <p className='ml-3 opacity-50 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3242 Reviews</p>
                            </div>
                ...
                <section style={{ paddingLeft: '18px' }}>
                    <h1 className='pb-4 text-xl font-bold'>Recent Rating and Reviews</h1>
                    <Grid container spacing={7}>
                        ...
                        <Grid item xs={5}>
                            ...
                            <div className='flex items-center space-x-3'>
                                ...
                                <p className='opacity-60'>62534 Ratings</p>
                            </div>
                ...
                <section style={{ paddingLeft: '18px' }}>
                    <h1 className='pb-4 py-t text-xl font-bold'>Similar Products</h1>
